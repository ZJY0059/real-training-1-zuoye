  ...
  <div>
    ...
    <el-dialog :title="title" :visible.sync="dialogVisible" width="50%">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="paramsqd('form')">确 定</el-button>
      </span>
    </el-dialog>
    ...
    <el-dialog :title="title1" :visible.sync="dialogVisible1" width="50%">
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="dialogVisible = false">取 消</el-button>
        <el-button type="primary" @click="paramsqd('form1')" v-show="id == 0"
          >确 定</el-button
        >
        <el-button type="primary" @click="paramsqd('form1')" v-show="id == 1"
          >确 定</el-button
        >
      </span>
    </el-dialog>
