...
<script>
import { securitytablePost, securitydepartmentGet } from "../../untils/api/social_securitys"
export default {
  data() {
    return {
      value: false,
  ...
  methods: {
    ...
    /*获取个人信息*/
    detailinfo() {
      securitydepartmentGet(this.$route.params.id).then((res) => {
        // console.log(res)
